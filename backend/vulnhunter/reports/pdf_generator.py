...
class VulnHunterReportGenerator:
    ...
    def _create_risk_analysis(self, scan_data):
        ...
        story.append(Paragraph("Análisis por Categoría OWASP Top 10 2025:", self.styles['SubSectionTitle']))
    ...
    def _create_comprehensive_technical_appendix(self, scan_data):
        ...
        methodology_text = f"""
        <b>Marco de Evaluación:</b> OWASP Top 10 2025, NIST Cybersecurity Framework<br/>
...
"""
    ...
    def _generate_compliance_mapping(self, vulnerabilities):
        ...
        compliance_text = """
        <b>Cumplimiento OWASP Top 10 2025:</b><br/>
        """
